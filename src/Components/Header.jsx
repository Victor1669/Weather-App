export default function Header({ children, states: [showUnits] }) {
  const LogoSVG = (
    ...
    >
      ...
      <defs>
        <clipPath id="a">
          <path className="light" fill="#fff" d="M0 0h196.864v40H0z" />
        </clipPath>
      </defs>
    </svg>
  );
...
export function HeaderButton({
  ...
  return (
    <button
      className="h-dropdown-button generalBackground focus-ouline hover"
      onClick={() => {
        setShowUnits((s) => !s);
        setShowDays(false);
...
export function UnitsButton({ units, setUnits }) {
  return (
    <button
      className="h-dropdown-unit-button focus-ouline hover"
      onClick={() =>
